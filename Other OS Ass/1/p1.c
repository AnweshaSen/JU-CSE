//     1. a.    Design a CPU scheduler for jobs whose execution profiles will be in a file that is to be read and appropriate scheduling algorithm to be chosen by the scheduler.
...
// Testing:
//     a. Create job profiles for 20 jobs and use three different scheduling algorithms (FCFS, Non-preemptive Priority and Round Robin (time slice:20)). 
...
void sortJobs(JobDB store[], int value)
{
