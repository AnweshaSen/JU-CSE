// Implement the following applications using different IPC mechanisms. 
// Your choice is restricted to Pipes, FIFOs, and Message Queues (use different mechanisms for each program) 
// b. Telephonic conversation (between a caller and a receiver) 

// This is implemented by message passing
